...
Here is our first plot that is just simply all the values in the aging data set. For the function to work the value you want to plot must be given to the y argument in ggplot, changing the orientation is done with `+ coord_flip()`.
...
Let's add a covariate on top of this all!
